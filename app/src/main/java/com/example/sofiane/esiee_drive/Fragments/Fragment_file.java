...
public class Fragment_file extends ListFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                displayDocument(items.get(position));
            }
        });
    }
    ...
    private void displayDocument(String fileName){
        ...
        final StorageReference riversRef = storage.getReferenceFromUrl("gs://schooldrive-459b1.appspot.com").child(yearName + "/" + subjectName + "/" + fileName);
        ...
        riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                baseIntent.setData(Uri.parse((uri.toString())));
                startActivity(Intent.createChooser(baseIntent, "Select Application"));
    ...
    public void showFileChooser() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Document to upload"), PICK_FILE_REQUEST);
    }
    ...
    private void writeNewDirectory(String yearName, String subjectName, String fileName) {
        ...
        mDataRef.child("directories").child(yearName).child("subject").child(subjectName).child("course").child(name).setValue(System.currentTimeMillis());
    }
